...
const NutritionPopup: React.FC<NutritionPopupProps> = ({ info, position, itemRect }) => {
    ...
    return (
        <div
            ref={popupRef}
            className={`absolute ${adjustedPosition === 'left' ? 'right-full mr-4' : 'left-full ml-4'} top-1/2 -translate-y-1/2 w-80 !bg-white opacity-100 rounded-xl shadow-lg border p-6 z-[999]`}
        >
